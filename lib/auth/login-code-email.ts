...
<body style="margin:0;padding:32px;background:#0f172a;font-family:sans-serif;">
  <div style="max-width:420px;margin:0 auto;background:#fff;border-radius:16px;padding:32px;text-align:center;">
    <div style="width:48px;height:48px;line-height:48px;border-radius:12px;background:#ef4423;color:#fff;font-size:22px;font-weight:700;margin:0 auto;">N</div>
    ...
    <div style="font-size:28px;font-weight:700;letter-spacing:6px;color:#c9361d;padding:14px;background:#ffe1d6;border-radius:10px;">${code}</div>
  </div>
</body>
</html>`;
}
