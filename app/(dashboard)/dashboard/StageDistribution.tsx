...
function MiniBar({
  ...
  return (
    <div className="h-2 rounded-full bg-slate-100">
      <div
        className={`h-2 rounded-full ${tone === "orange" ? "bg-orange-500" : "bg-slate-400"}`}
        style={{ width: `${width}%` }}
      />
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative flex max-h-[86vh] w-full max-w-5xl flex-col overflow-hidden rounded-xl bg-slate-50 shadow-2xl"
      >
        ...
        <div className="flex items-center justify-between gap-4 border-b border-slate-100 px-4 py-4">
          <div>
            <button
              ...
              className="text-left text-sm font-semibold text-slate-950 underline-offset-4 hover:text-orange-700 hover:underline"
            >
              Project Stages
            </button>
          </div>
